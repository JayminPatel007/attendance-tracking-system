...
class SyncResponse {
  ...
  int get hashCode =>
    ...
    (appliedCount == null ? 0 : appliedCount!.hashCode);

  @override
  String toString() => 'SyncResponse[appliedCount=$appliedCount]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (this.appliedCount != null) {
      json[r'appliedCount'] = this.appliedCount;
    } else {
      json[r'appliedCount'] = null;
    }
    return json;
  }
  ...
  static SyncResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SyncResponse(
        appliedCount: mapValueOfType<int>(json, r'appliedCount'),
      );
    }
    return null;
  }
